...
feature_names <- read.csv(file = "../2_FeatureCorrectionAndFilter/keep_non_survey_context_cols2.csv", header=FALSE)
...
p = p + coord_flip()
p = p + scale_y_continuous(breaks=seq(-0.15,0,by=0.05), labels=abs(seq(-0.15,0,by=0.05)), limits=c(-0.15,0))
p

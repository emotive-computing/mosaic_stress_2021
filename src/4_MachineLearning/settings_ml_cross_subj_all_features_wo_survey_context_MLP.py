...
Settings.IO.RESULTS_OUTPUT_FOLDER = "./results_ncx_feats_cross_subj_MLP"
...
Settings.MODELS_TO_RUN = [MLPRegressor]
...
Settings.CROSS_VALIDATION.HYPER_PARAMS.MODEL = {
    ...
    ElasticNet.__name__:{
        ...
        'alpha': [0.01, 0.1, 1.0],
        'l1_ratio': [0.6, 0.7, 0.8, 0.9, 0.95, 0.99]
    },
    MLPRegressor.__name__:{
        'hidden_layer_sizes': [(20,100, 100, 100,20)],
        'activation': ['tanh'],
        'solver': ['sgd'],

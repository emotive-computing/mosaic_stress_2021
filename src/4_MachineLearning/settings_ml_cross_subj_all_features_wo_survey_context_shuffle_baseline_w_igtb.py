...
Settings.IO.DATA_INPUT_FILE = "../2_FeatureCorrectionAndFilter/results/merge_all_time_summary_not_blinded_outlier_treated_08_12_with_baseline_corrected_non_survey_context_feats_w_igtb.csv"

# Folder to output results in, helpful to change if you don't want to overwrite previous results
Settings.IO.RESULTS_OUTPUT_FOLDER = "./results_ncx_feats_cross_subj_shuffle_baseline_w_igtb"

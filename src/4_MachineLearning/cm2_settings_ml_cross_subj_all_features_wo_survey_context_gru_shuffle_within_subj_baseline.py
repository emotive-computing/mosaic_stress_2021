...
def my_gru_model_func(params):
    model = keras.models.Sequential()
    model.add(keras.layers.GRU(params['layer_width'], return_sequences=False))
...
def RunML():
    ...
    tfm.set_fit_params({'batch_size': 32, 'validation_split': 0, 'epochs': 50})
    ...
    p.getDC().save('cm2_results_ncx_feats_cross_subj_gru_shufwtn_baseline')
